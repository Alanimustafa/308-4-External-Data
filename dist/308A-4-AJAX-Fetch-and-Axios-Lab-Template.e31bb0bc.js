...
var API_KEY = "live_pqwQ5FVkfUBP8OSQW7FxEjD19bhRFPkVytGmMmpnJ7SG2X9cFDfSLAjOTaXvgr5E";
  ...
  _initialLoad = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          breedsFetch = _context.sent;
          _context.next = 6;
          return breedsFetch.json();
        case 6:
          breedsFetchJSON = _context.sent;
          allBreedArray = breedsFetchJSON; // All breeds object have been collected in allBreedArray.

          console.log(allBreedArray);
          for (i = 0; i < allBreedArray.length; i++) {
...
var breedDetail = []; // The array for each breed property.
function retreiveTheBreed() {
  return _retreiveTheBreed.apply(this, arguments);
}
/**
 ...
 */
function _retreiveTheBreed() {
  _retreiveTheBreed = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var selectedBreed, breedURL, responseBreed, dataBreed, previousImgID, i, breedImageURL, responseImage, dataImage, url, imageID, imgAlt, imageItem;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          Carousel.clear(); //clears the existing images and info
          _context2.prev = 1;
          selectedBreed = breedSelect.value; // console.log("Selected value:", selectedBreed);
          breedURL = "https://api.thecatapi.com/v1/breeds/" + selectedBreed;
          _context2.next = 6;
        ...
        case 6:
          responseBreed = _context2.sent;
          _context2.next = 9;
          return responseBreed.json();
        case 9:
          dataBreed = _context2.sent;
          breedDetail = dataBreed;

          // this section is to fetch 10 images of the selected breed
          previousImgID = ""; //this is to check if consecutive images are same if so break out of loop
          i = 0;
        case 13:
          if (!(i < 11)) {
            _context2.next = 32;
          ...
          breedImageURL = "https://api.thecatapi.com/v1/images/search?breed_ids=" + selectedBreed; //creating url using
          _context2.next = 17;
          return fetch(breedImageURL, {
            headers: {
              "x-api-key": API_KEY
            }
          });
        case 17:
          responseImage = _context2.sent;
          _context2.next = 20;
          return responseImage.json();
        case 20:
          dataImage = _context2.sent;
          url = dataImage[0].url;
          imageID = dataImage[0].id;
          if (!(imageID === previousImgID)) {
            _context2.next = 25;
            break;
          }
          return _context2.abrupt("break", 32);
        case 25:
          //if two images are the same then end loop
          previousImgID = imageID;
          imgAlt = "Image of " + dataImage[0].breeds[0].name;
          imageItem = Carousel.createCarouselItem(url, imgAlt, imageID);
...
//# sourceMappingURL=/308A-4-AJAX-Fetch-and-Axios-Lab-Template.e31bb0bc.js.map